# 2022
# Implemented by Rong Yiming for multiscale cif
...
from fairseq.data import AddMultiTargetsDataset, Dictionary, encoders
...
@register_task("multiscale_cif", dataclass=MultiscaleCifConfig)
class MultiscaleCifTask(AudioPretrainingTask):
    """ """
